    ...
    <div class="container mt-5">
        ...
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="pic" name="pic" value="<?php echo $row['pic']; ?>" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="nama_spek" name="nama_spek" value="<?php echo $row['nama_spek']; ?>" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="nilai" name="nilai" value="<?php echo $row['nilai']; ?>" required>
                    <div class="valid-feedback">
                    </div>
                </div>
                </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="serial_number" name="serial_number" value="<?php echo $row['serial_number']; ?>" required>
            </div>
